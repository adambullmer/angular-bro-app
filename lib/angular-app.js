...
AngularApp.prototype.processAngularTemplates = function (templates) {
    ...
    templates = concat(templates, {
        ...
        inputFiles : [ '**/*.js' ],
        annotation : 'Concat: Wrapping Templates'
    });
...
AngularApp.prototype.runLinter = function (appScriptsTree, appStylesTree) {
    ...
    return new Funnel(mergeTrees([lintScripts, styleScripts, lintStyles], { overwrite: true, annotation: 'Merge Trees: Linting' }), {
        destDir: 'tests/lint',
...
AngularApp.prototype.toTree = function () {
    ...
    if (this.isProduction) {
        ...
        appScripts    = uglifyJs(appScripts, {annotation: 'Uglify JS: App'});
        vendorScripts = uglifyJs(vendorScripts, {annotation: 'Uglify JS: Vendor'});

        appStyles    = less(appStyles, 'styles/app.css', 'styles/app.css', { compress: true, annotation: 'Less: Minify App CSS' });
        vendorStyles = less(vendorStyles, 'styles/vendor.css', 'styles/vendor.css', { compress: true, annotation: 'Less: Minify Vendor CSS' });
    ...
    return mergeTrees([testResults, assets], { overwrite: true, annotation: 'Merge Trees: Test results, all' });
};
