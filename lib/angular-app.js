...
AngularApp.prototype.runTests = function (appScriptsTree, addonsScriptsTree, vendorScriptsTree, lintingResults) {
    ...
    return mergeTrees([lintingResults, unitTestingResults], { annotation: 'Merge Trees: Linting Results, Unit Tests' });
};
...
AngularApp.prototype.toTree = function () {
    ...
    return mergeTrees([testResults, assets], { annotation: 'Merge Trees: Test results, all' });
};
